...
Invoke-WebRequest ($templateBaseUrl + "artifacts/create-sa.yaml") -OutFile "C:\Temp\create-sa.yaml"
Invoke-WebRequest ($templateBaseUrl + "artifacts/grant-role.yaml") -OutFile "C:\Temp\grant-role.yaml"
Invoke-WebRequest ($templateBaseUrl + "artifacts/create_kubeconfig.sh") -OutFile "C:\Temp\create_kubeconfig.sh"
